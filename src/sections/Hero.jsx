          ...
          <div className="space-y-8">
            <div className="animate-fade-in">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary">
                ...
                MERN Stack Davloper • Frontend Specialist
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I'm Ayan Sidatar — a mern stack davloper specializing in
                React.js, Next.js, Node.js, Express, Tailwind and Mongodb. I
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                {
                  icon: Github,
                  href: "https://github.com/Sidan-007/MERN-Stack-Projects",
                },
                {
                  icon: Linkedin,
                  href: "https://www.linkedin.com/in/ayan-sidatar-640449369/",
                },
              ].map((social, idx) => (
                <a
                  key={idx}
